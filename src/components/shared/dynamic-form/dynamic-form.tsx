    ...
    return (
        <Card className="w-full min-w-xl p-5">
            <CardHeader>
                ...
                <CardDescription>
                    This dynamic form is a nextjs , built with shadcn ui components , with form
                    hooks and zod builders.
                    Form is simulated into ui from standardized json schema definition
                </CardDescription>
            </CardHeader>
            <Separator
